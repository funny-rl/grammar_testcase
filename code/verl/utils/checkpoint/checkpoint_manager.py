...
class BaseCheckpointManager:
    ...
    def __init__(
        ...
        checkpoint_load_contents = None #checkpoint_contents.get("load_contents", None) if checkpoint_contents else None
        checkpoint_save_contents = None #checkpoint_contents.get("save_contents", None) if checkpoint_contents else None
